...
A vantagem do `brms` é a produtividade: modelos padrão (gaussiano, binomial, Poisson) são especificados em uma linha. A estrutura interna do modelo fica oculta, razão pela qual o `rstan` foi apresentado primeiro.
